...
MODEL_INFO = {
        ...
        "keys": ["GS", "JPM", "MS", "C", "WFC", "BAC", "COF", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["GS", "JPM", "MS", "C", "WFC", "BAC", "COF", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"]]
}
